      ...
      <Modal open={show} onClose={handleModalClose} size={size} closeIcon>
        {title && (
          <Modal.Header className="centeredHeaderTerms">
            {title}
            <img src={image.logoSennovalabNoC} alt="" className="logo" />
          </Modal.Header>
        )}
        <Modal.Content>
          ...
          <div className="modalTermsBody">
            <Grid className="content-modal-terms">
              <Grid.Row>
              ...
              <Grid.Row>
                ...
                <Grid.Column width={14}>
                  <p>
                    Todos los derechos de propiedad intelectual en relación
              ...
              <Grid.Row>
                ...
                <Grid.Column width={14}>
                  <p>
                    En la medida permitida por la ley aplicable, excluimos
          ...
          <div className="acceptanceSection">
            <div className="questionContainer">
              <p>He leído y acepto los Términos y Condiciones y Política de
            privacidad de SENNOVALAB</p>
