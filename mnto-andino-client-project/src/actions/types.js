...
export const UPDATE_MAKINA_ANDINA_SUCCESS = "UPDATE_MAKINA_ANDINA_SUCCESS";
export const UPDATE_MAKINA_ANDINA_FAILURE = "UPDATE_MAKINA_ANDINA_FAILURE";
export const GET_MAKINA_ANDINAS_SUCCESS = "GET_MAKINA_ANDINAS_SUCCESS";
export const GET_MAKINA_ANDINAS_FAILURE = "GET_MAKINA_ANDINAS_FAILURE";
...
export const CREATE_MAKINA_ANDINA_MIAMI_SUCCESS =
  "CREATE_MAKINA_ANDINA_MIAMI_SUCCESS";
export const CREATE_MAKINA_ANDINA_MIAMI_FAILURE =
  "CREATE_MAKINA_ANDINA_MIAMI_FAILURE";
export const UPDATE_MAKINA_ANDINA_MIAMI_SUCCESS =
  "UPDATE_MAKINA_ANDINA_MIAMI_SUCCESS";
export const UPDATE_MAKINA_ANDINA_MIAMI_FAILURE =
  "UPDATE_MAKINA_ANDINA_MIAMI_FAILURE";
export const GET_MAKINA_ANDINA_MIAMI_SUCCESS =
  "GET_MAKINA_ANDINA_MIAMI_SUCCESS";
export const GET_MAKINA_ANDINA_MIAMI_FAILURE =
  "GET_MAKINA_ANDINA_MIAMI_FAILURE";
export const DELETE_MAKINA_ANDINA_MIAMI_SUCCESS =
  "DELETE_MAKINA_ANDINA_MIAMI_SUCCESS";
export const DELETE_MAKINA_ANDINA_MIAMI_FAILURE =
  "DELETE_MAKINA_ANDINA_MIAMI_FAILURE";

export const CREATE_GLAMPING_SUCCESS = "CREATE_GLAMPING_SUCCESS";
export const CREATE_GLAMPING_FAILURE = "CREATE_GLAMPING_FAILURE";
export const UPDATE_GLAMPING_SUCCESS = "UPDATE_GLAMPING_SUCCESS";
export const UPDATE_GLAMPING_FAILURE = "UPDATE_GLAMPING_FAILURE";
export const GET_GLAMPING_SUCCESS = "GET_GLAMPING_SUCCESS";
export const GET_GLAMPING_FAILURE = "GET_GLAMPING_FAILURE";
export const DELETE_GLAMPING_SUCCESS = "DELETE_GLAMPING_SUCCESS";
export const DELETE_GLAMPING_FAILURE = "DELETE_GLAMPING_FAILURE";
